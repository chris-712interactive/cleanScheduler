          ...
          <article className={styles.doc}>
            ...
            <ul>
              ...
              <li>
                ...
                device location (latitude, longitude, and accuracy) at the moment a crew member
                checks in to a visit — or when office staff complete a visit that still needs
                check-in. Location is requested through the browser only at that moment (not
                continuously), used to show arrival proof to that workspace’s staff, and is not used
                for live fleet tracking. If location permission is denied or unavailable, check-in
                still works without coordinates.
              </li>
              <li>
