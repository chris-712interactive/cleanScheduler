...
import { MARKETING_FAQ } from '@/lib/marketing/homepageContent';
...
export default function HelpFaqPage() {
  const jsonLd = buildFaqJsonLd(MARKETING_FAQ);
    ...
    <main className={styles.page}>
      <Container size="md">
        ...
        <p className={styles.faqAnswer}>
          Still have questions? Visit our <Link href="/help/contact">contact page</Link> or{' '}
