...
export const INFORMATION_SECURITY_POLICY_SECTIONS: PolicySection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      'Third-party services that process data on our behalf are listed in the Privacy Policy and Security page. Material subprocessors include Supabase, Stripe, Vercel, Resend, Google (OAuth and Analytics), Sent (sent.dm), and Plaid (bank reconciliation).',
