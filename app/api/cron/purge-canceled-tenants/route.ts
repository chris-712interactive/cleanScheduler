...
import { purgeCanceledWorkspaces } from '@/lib/billing/tenantPurge';
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const result = await purgeCanceledWorkspaces(admin);
    ...
    const msg = e instanceof Error ? e.message : 'Purge canceled tenants failed';
