        ...
        <header className={styles.sectionHeader}>
          ...
          <p className={styles.sectionLead}>
            {isSitePublished
              ...
              : 'Publish this page when ready. It will appear once the website is published.'}
          </p>
        </header>
          ...
          <div className={styles.editorColumn}>
            <section className={styles.setupCard}>
              <header className={styles.sectionHeader}>
                ...
                <p className={styles.sectionLead}>The headline block at the top of the page.</p>
              </header>
            ...
            <section className={styles.setupCard}>
              <header className={styles.sectionHeader}>
                <h2 className={styles.sectionTitle}>Content sections</h2>
                <p className={styles.sectionLead}>
                  Add, edit, or remove sections and their paragraphs or bullet lists.
                </p>
              </header>
            ...
            <section className={styles.setupCard}>
              <header className={styles.sectionHeader}>
                ...
                <p className={styles.sectionLead}>Questions and answers shown near the bottom.</p>
              </header>
          ...
          <div className={styles.editorColumn}>
            <section className={styles.setupCard}>
              <header className={styles.sectionHeader}>
                ...
                <p className={styles.sectionLead}>How this page appears in search results.</p>
              </header>
              <div className={styles.stack}>
                <label className={styles.fieldLabel}>
                  Slug
            ...
            <section className={styles.setupCard}>
              <header className={styles.sectionHeader}>
                <h2 className={styles.sectionTitle}>Bottom call to action</h2>
                <p className={styles.sectionLead}>Optional closing banner before the footer.</p>
              </header>
              <div className={styles.stack}>
                <label className={styles.fieldLabel}>
                  CTA title
